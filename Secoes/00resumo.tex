\begin{abstract}
   ...
   Neste trabalho, é feita uma breve revisão da literatura a fim de identificar o estado da arte de detecção de notícias falsas, quais são as abordagens mais utilizadas em termos de modelagem do problema; quais as técnicas de processamento de linguagem natural e os algoritmos de aprendizado de máquina que são mais eficazes para esta tarefa. Por fim, são feitos experimentos utilizando a rede neural \textbf{BERT}, que mostram o poder dessa tecnologia, que alcança resultados acima de X\% de acurácia e Y\% de F1.\xexeo{Por favor, coloque aqui um pequeno resumo dos resultados}
